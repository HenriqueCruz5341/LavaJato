<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
	...
	<table class="table">
			...
			foreach ($this->dados as $linha) {
				...
				<tr>
					...
					<td>
						...
						<a class="btn btn-warning" href="<?= URL; ?>controller-carro/editar/<?= $idCarro;?>" role="button">Editar</a>
		...
		<a class="btn btn-dark" href="<?=URL .'controller-carro/inserir'?>" role="button">Inserir</a>
